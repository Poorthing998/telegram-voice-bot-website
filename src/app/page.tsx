...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.typegone.com/' },
};
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-16 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="flex flex-col items-start">
              <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-mint/20 text-mint text-xs font-semibold mb-10 opacity-0 animate-fade-up" style={{ background: 'rgba(0,229,160,0.06)' }}>
              ...
              <h1 className="font-display font-extrabold tracking-tight mb-8 opacity-0 animate-fade-up" style={{ fontSize: 'clamp(3rem, 7vw, 5.5rem)', lineHeight: 1.02, animationDelay: '0.05s' }}>
              ...
              <p className="text-xl md:text-2xl text-text-muted max-w-xl mb-4 leading-relaxed font-light opacity-0 animate-fade-up" style={{ animationDelay: '0.1s' }}>
                AI voice to text that actually formats.
              </p>
              <p className="text-base text-text-dim max-w-lg mb-12 leading-relaxed opacity-0 animate-fade-up" style={{ animationDelay: '0.15s' }}>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-8 opacity-0 animate-fade-up" style={{ animationDelay: '0.2s' }}>
                <a
              ...
              <div className="flex items-center gap-5 text-xs text-text-dim opacity-0 animate-fade-up" style={{ animationDelay: '0.25s' }}>
              ...
              <div className="flex items-center gap-4 mt-4 text-xs text-text-dim opacity-0 animate-fade-up" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="opacity-0 animate-slide-in-right" style={{ animationDelay: '0.15s' }}>
              <HeroVisual />
            </div>
          </div>
        </div>
