...
export const SUPPORT_EMAIL = 'hello@typegone.app';
...
export const DATA_PRIVACY_FAQS = [
  ...
  { question: 'Can I request deletion of my data?', answer: 'Yes. You can contact us at hello@typegone.app to request deletion of all your account data. Since we don\'t store voice or transcription content, the only data to delete is your account preferences and usage statistics.' },
